    ...
    <div class="container mx-auto px-4">
        ...
        <div class="space-y-8 divide-y divide-gray-200 w-1/2 mt-10">
            ...
            <div class="sm:col-span-6 pt-5">
                ...
                <div class="mt-1">
                    <textarea id="textarea" rows="3" wire:model="post.body" class="shadow-sm focus:ring-indigo-500 appearance-none bg-white border border-gray-400 rounded-md py-2 px-3 text-base leading-normal transition duration-150 ease-in-out focus:border-indigo-500 block w-full sm:text-sm border-gray-300 rounded-md"></textarea>
                </div>
...
<script src="https://cdn.tiny.cloud/1/8xc3fwyv6kq6inmfsj5efvkq1ghxruv71xpbi8iwera9652r/tinymce/5/tinymce.min.js" referrerpolicy="origin"></script>
