        ...
        <section class="clients">
          ...
          <ul class="clients-list has-scrollbar">
            ...
            <li class="clients-item">
              <a href="#">
                <img src="./assets/images/laravel.png" alt="client logo">
                <div class="caption"><h1>Laravel</h1></div>
              </a>
            </li>

            <li class="clients-item">
              <a href="#">
                <img src="./assets/images/aws.png" alt="client logo">
                <div class="caption"><h1>AWS Cloud Server</h1></div>
              </a>
            </li>

            <li class="clients-item">
              <a href="#">
                <img src="./assets/images/github.png" alt="client logo">
                <div class="caption"><h1>GITHUB</h1></div>
              </a>
            </li>

            <li class="clients-item">
              <a href="#">
                <img src="./assets/images/mysql.png" alt="client logo">
                <div class="caption"><h1>MySQL Database</h1></div>
              </a>
            </li>

            <li class="clients-item">
              <a href="#">
                <img src="./assets/images/react.png" alt="client logo">
                <div class="caption"><h1>React</h1></div>
              </a>
            </li>

            <li class="clients-item">
              <a href="#">
                <img src="./assets/images/bootstrap.png" alt="client logo">
                <div class="caption"><h1>Bootstrap</h1></div>
              </a>
            </li>

            <li class="clients-item">
              <a href="#">
                <img src="./assets/images/html.png" alt="client logo">
                <div class="caption"><h1>HTML</h1></div>
              </a>
            </li>
